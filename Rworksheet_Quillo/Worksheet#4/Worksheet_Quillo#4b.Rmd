...
n <- as.integer(readline("Enter the starting Fibonacci sequence number: "))
...
#gsub("black", "Black", alexa_file$variation )
gsub("Black Plus", "BlackPlus", alexa_file$variation)
gsub("Black Show", "BlackShow", alexa_file$variation)
gsub("Black Spot", "BlackSpot", alexa_file$variation)
gsub("Black Dot", "BlackDot", alexa_file$variation)
gsub()
...
```{r}
  ...
  allBlack <- c("Black","Black Plus","Black Show","Black Spot", "Black Dot")
  allWhite <-c("White", "White Dot", "White Plus", "White Show", "White Spot")
  
  allofBlack <- Variations.RDara[Variations.RDara$`alexa_file$variation` %in% "Black Plus",]
  
  allofWhite <- Variations.RDara[Variations.RDara$`alexa_file$variation` %in% allWhite, ]
